                    ...
                    >
                      ...
                      {isCurrent ? (
                        ...
                        <button
                          ...
                          aria-label={t("settings.notifications.removeDevice")}
                          className="shrink-0 rounded-md p-1 text-muted-foreground transition hover:bg-muted/60 hover:text-destructive"
                        >
