...
import { Wallet, Repeat2, CalendarIcon, Tag } from "@/lib/icons";
...
export function TransactionSidebar({
  ...
  return (
    <motion.div
      ...
      className="divide-y divide-border/30 rounded-2xl border border-border/30 bg-card shadow-[0_2px_8px_rgba(0,0,0,0.04)] py-1"
    >
