...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent outline-none transition duration-200 ease-out",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block rounded-full bg-background shadow-sm shadow-black/25 transition duration-200 ease-out ring-1 ring-foreground/10 dark:shadow-black/40 dark:ring-foreground/15",
