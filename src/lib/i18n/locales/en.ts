...
export const app: AppTranslationMessages = {
  ...
  settings: {
    ...
    security: {
      ...
      description:
        "Manage your password, authenticator app, active sessions, and account",
  ...
  dashboard: {
    ...
    currentMonthHint: "You are viewing the current month",
    years: "Years",
    prevDecade: "Previous decade",
    nextDecade: "Next decade",
    jumpToCurrentYear: "Jump to current year",
    toggleYearRange: "Toggle month / year view",
    customize: "Customize",
    ...
    customizeReorder: "Reorder card",
    customizeReorderHint:
      "Drag the handle to reorder cards within each section",
    cards: {
  ...
  notifications: {
    title: "Notifications",
    description: "All alerts, read and unread, for the current space.",
    total: "Total alerts",
    unread: "Unread",
    tabAll: "All",
    tabUnread: "Unread",
    tabRead: "Read",
    tabsLabel: "Filter notifications",
    ...
    emptyDescription:
      "Alerts about budgets, goals, subscriptions and spending will appear here.",
    noFiltered: "Nothing here",
    clearAll: "Clear notifications",
    clearing: "Clearing…",
    clearConfirmTitle: "Delete all notifications?",
    clearConfirmDescription:
      "This permanently deletes every notification for this space. This action cannot be undone.",
    clearSuccess: "Notifications cleared",
    clearError: "Couldn't clear notifications",
    groups: {
      today: "Today",
      yesterday: "Yesterday",
      thisWeek: "This week",
  ...
  distribution: {
    ...
    overspent: "Overspent",
    savingsRate: "Savings rate",
    overspentBy: "Overspent by {{amount}} of income",
    ofIncome: "of income",
  ...
  charts: {
    ...
    month: "Month",
    overlays: "Overlays",
    overlaysDesc: "Show budget and goal reference lines",
    layers: "Layers",
    settings: "Chart settings",
    settingsDesc: "Customize how this chart looks",
  ...
  transactions: {
    ...
    deleteConfirmBulk:
      "Delete the {{count}} selected transactions? This action cannot be undone.",
    bulkDeleteSuccess: "Transactions deleted",
    bulkDeleteError: "Could not delete the transactions. Please try again.",
    export: "Export",
